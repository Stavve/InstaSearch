...
return array_map('realpath', array(
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Contracts/Config/MyRepository.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Config/MyRepository.php',
